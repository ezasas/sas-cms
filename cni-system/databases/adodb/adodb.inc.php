...
*/
   ...
   */
	...
	*/
	...
	/**
	* Return the fields array of the all row as an object for convenience.
	* The default case is lowercase field names.
	*
	* @return the object with the properties set to the fields of the all row
	* Added by alie
	*/
	function &FetchAllObj(){
		for( $i=0; $i<$this->_numOfRows; $i++ ){
			$o[$i] = &$this->FetchNextObj();
		}
		return $o;
	}
